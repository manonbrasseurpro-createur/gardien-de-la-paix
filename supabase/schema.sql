...
-- Agrégat public (moyenne + nombre) sans exposer les avis non publiés
...
-- Partenaires (admin) : codes promo Stripe et suivi des inscriptions affiliées
